...
def test_logged_out_article_view_no_buttons(app, loaded_db_item):
    response = app.get('/article/{}'.format(loaded_db_item.id))
    assert 'href="/edit_entry/{}"'.format(loaded_db_item.id) not in response.text
    assert 'href="/delete_entry/{}"'.format(loaded_db_item.id) not in response.text


def test_logged_in_article_view_show_buttons(authorized_app, loaded_db_item):
    response = authorized_app.get('/article/{}'.format(loaded_db_item.id))
    assert 'href="/edit_entry/{}"'.format(loaded_db_item.id) in response.text
    assert 'href="/delete_entry/{}"'.format(loaded_db_item.id) in response.text
